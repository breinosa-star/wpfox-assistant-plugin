...
// GrayFox_Google stub
// -----------------------------------------------------------------------
if ( ! class_exists( 'GrayFox_Google' ) ) {
	class GrayFox_Google {
		...
		/** @var string|null $stub_token Value returned by get_access_token() in tests. */
		public ?string $stub_token = 'test-access-token';
...
// -----------------------------------------------------------------------
// Autoload GrayFox_Booking
// -----------------------------------------------------------------------
require_once dirname( __DIR__ ) . '/includes/class-grayfox-booking.php';

// -----------------------------------------------------------------------
// Autoload GrayFox_Drive
// -----------------------------------------------------------------------
require_once dirname( __DIR__ ) . '/includes/class-grayfox-drive.php';
